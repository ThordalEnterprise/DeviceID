...
extern void *mono_aot_module_DeviceID_iOS_info;
...
extern void *mono_aot_module_DeviceID_info;
...
extern void *mono_aot_module_Hardware_Info_info;
extern void *mono_aot_module_System_Management_info;
extern void *mono_aot_module_System_CodeDom_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_DeviceID_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_DeviceID_info);
	...
	mono_aot_register_module (mono_aot_module_Hardware_Info_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "DeviceID.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
